export default [
    ...
    },
    {
        ...
        fields: {
            name: 'Roadery',
            headline: 'This solution will allow users (accident victims) to send emergency messages through the web or using SMS to road warden for any emergency situation',
            color: '#4D2CFF',
            theme: 'Good Health and Well-being',
