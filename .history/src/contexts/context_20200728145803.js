...
class ProjectProvider extends Component {
    ...
    componentDidMount() {
        ...
        let zeroHunger = projects.fi(project => project.theme === 'Zero-Hunger');
        let patnership = projects.fi(project => project.theme === 'Patnerships-for-goals');
        let goodHealth = projects.fi(project => project.theme === 'Good-Health-and-Well-being');
        let qualityEdu = projects.fi(project => project.theme === 'Quality-Education');
        let peaceAndJustice = projects.fi(project => project.theme === 'Peace-And-Justice');
        let decentWork = projects.fi(project => project.theme === 'Decent-Work');
        let industryInno = projects.fi(project => project.theme === 'Industry-innovation');
        let sustainableCities = projects.fi(project => project.theme === 'Sustainable-Cities');
