...
class ProjectProvider extends Component {
    ...
    componentDidMount() {
        ...
        let zeroHunger = [..noPoverty,projects].filter(project => project.theme === 'Zero-Hunger');
        ...
        let industryInno = projects.filter(project => project.theme === 'Industry-innovation');
        let sustainableCities = projects.filter(project => project.theme === 'Sustainable-Cities');
