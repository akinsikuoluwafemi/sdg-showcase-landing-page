export default [
    ...
    },
    {
        ...
        fields: {
            name: "Farmzone",
            about: "It allows for farmers to have an easy and accessible market to regular user. The farmers also get a forum to connect with other farmers and discuss issues pertaining to farms and catch up. Our platform is easy to use and available to all.",
            color: '#DDA639',
            theme: 'Zero-Hunger',
            headline: "My teams project is inspired by the need to bring farmers in remote farms / areas a market within their reach. Here on farmzone they can sell to regular users who are looking for affordable produce. Connecting the two together with service providers is the inspiration behind our project.",
            featured: false,
            videoLink: '',
            stackused: ["React Js"],
            nationality: ["Nigeria"],
