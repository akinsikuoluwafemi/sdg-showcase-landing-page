export default [
...

    {
        ...
        fields: {
            ...
            color: '#DDA639',
            theme: 'Zero-Hunger',
            about: "This project would connect farmers to markets of consumers or vendors (in form of individuals, corporate, governments and international organizations). food reservoirs could be set up by the vendors and form part of government policy including budgeting.
the application will also have a map to pin- point the various activities and entire chain of farmers to vendors and vice- versa.",
            featured: false,
