export default [
    ...
    },
    {
        ...
        fields: {
            name: 'RoadMaster',
            about: "This project alerts road users within range of a crash to the presence of said crash. It also alerts emergency responders and supplies prior information of crash victims to aid necessary evacuation plans.
The app suggests alternate routes to other road users and helps emergency responders keep detailed information of crashes.",
            color: '#4C9F38',
            theme: 'Good-Health-and-Well-being',
