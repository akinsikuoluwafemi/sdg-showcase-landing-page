export default [
    ...
    },
    {
        ...
        fields: {
            ...
            image: 'https://res.cloudinary.com/dt69gb9me/image/upload/f_auto,q_auto/v1596281012/Team_129_knbqdt.png',
    ...
    },
    {
        ...
        fields: {
            ...
            members: [
                ...
                "David Enoma",
                "Haastrup Elijah",
                "Ido Dickson Evergeen",
                "Ikechukwu Boniface"

            ],
            image: 'https://res.cloudinary.com/dt69gb9me/image/upload/f_auto,q_auto/v1596281353/team-237_k2l6pa.png',
...

    {
        ...
        fields: {
            ...
            color: '#DDA639',
            theme: 'Zero-Hunger',
            about: "This project would connect farmers to markets of consumers or vendors (in form of individuals, corporate, governments and international organizations). food reservoirs could be set up by the vendors and form part of government policy including budgeting. The application will also have a map to pin- point the various activities and entire chain of farmers to vendors and vice- versa.",
            featured: false,
    ...
    },
    {
        ...
        fields: {
            name: "Silos",
            headline: "The Inspiration was to have an ecommerce market place specifically for food producers to display their produce.",
            color: '#DDA639',
            theme: 'Zero-Hunger',
            about: "In the long run our initiative will boost food productivity and help eliminate hunger.",
            featured: false,
            videoLink: 'https://www.youtube.com/embed/8_llaKxc0Zg',
            stackused: ["React Js"],
            nationality: ["Nigeria"],
            email: "otokinaodafe@gmail.com",
            hostedlink: 'https://silos-app.netlify.app/',
            members: [
                "Godwin Otokina",
                "Benson Imoh",
                "Yunana Bala",
    ...
    },
    {
        ...
        fields: {
            name: "Food Network",
            headline: "My team inspiration comes from jumia ,with that in mind we want to generate a system that revolves around food .",
            color: '#DDA639',
            theme: 'Zero-Hunger',
            about: "The platform will empower any farmer regardless of their scale of production. This will enable even the small scale farmers have access to supoort in every step of the production activities. This inturn has the effect of contrubuting to a great extent on food security locally and globally. It will also have the effect of uplifting the living conditions of small scale farmers.",
            featured: false,
            videoLink: '',
            stackused: ["React Js"],
            nationality: ["Kenya"],
            email: "danronohkip@gmail.com",
            hostedlink: 'https://intense-dusk-42545.herokuapp.com/#/',
            members: [
                "Dan kipchirchir ronoh",
                "Nicholus",
                "peter",
                "ibrahimjee",
                "purity"
            ],
            image: 'https://res.cloudinary.com/dt69gb9me/image/upload/f_auto,q_auto/v1596266597/FoodNetwork_yjs3xa.png',
    ...
    },
    {
        ...
        fields: {
            name: "AFS",
            headline: "The COVID 19 lockdown has caused a lot of hunger and had brought down the income of various farmers in many places in Nigeria and in the world at large.",
            color: '#DDA639',
            theme: 'Zero-Hunger',
            about: "Our solution is a very simple web based application that connects farmers, consumers and farm investors. Farm produce consumer can get farm materials from our app with a few clicks and also farmers can connect and even chat with his client both investors and consumers in a very simple UI app without much stress.",
            featured: false,
            videoLink: '',
            stackused: ["React Js"],
            nationality: ["Nigeria"],
            email: "rasheedrtm1@gmail.com",
            hostedlink: 'http://bit.ly/buildforsdgteam044app',
            members: [
                "Mudasiru Rasheed",
                "Samuel Okoroh",
                "Oluwtosin Jimoh",
    ...
    },
    {
        ...
        fields: {
            name: "goOrganic",
            headline: "Our project is inspired by trying to increase food production in developing countries, but not only increase food production, but to increase rate of clean food production.",
            color: '#DDA639',
            theme: 'Zero-Hunger',
            about: "Our application intend to utilize USSD technology so as to reach as many people as possible even in remote areas to get access to necessary information that they may require, apply for insurance cover,  get guidance on how to practice organic farming and request for inputs from agrochemicals companies by just dialing a simple USSD code.",
            featured: false,
            videoLink: 'https://www.youtube.com/embed/8airlbyL2sg',
            stackused: ["Jest"],
            nationality: ["Kenya"],
            email: "mwangif184@gmail.com",
            hostedlink: 'https://buildforsdg.github.io/team-132-frontend/',
            members: [
                "Francis Mwangi",
                "Didas Mbalanya",
                "Amos Amoyo",
    ...
    },
    {
        ...
        fields: {
            name: "FarmLord",
            headline: "The inspiration for our project came from the need to resolve some of the observed problems of the agricultural sector, one being the lack of information about land and their prices.",
            color: '#DDA639',
            theme: 'Zero-Hunger',
            about: "The FarmLord solution bridges the gap between subsistence farmers and land owners by connecting subsistence farmers to land owners. It offers the farmers the opportunity to rent or lease the lands at affordable prices. It also increases productivity for farmers by facilitating seamless logistics and financial transactions involved in the process of obtaining lands for farming activities.",
            featured: false,
            videoLink: 'https://www.youtube.com/embed/mbyTks3_GGs',
            stackused: [],
            nationality: ["Nigeria"],
            email: "fortuneochi@gmail.com",
            hostedlink: 'https://farmlord.netlify.app/',
            members: [
                "Fortunatus Ochi",
                "Godstime Agho",
                "Ogunfusika Oluwatoni",
                "Olanrewaju Ajayi"
            ],
            image: '',
    ...
    },
    {
        ...
        fields: {
            name: "FarmSpired",
            headline: "Having observed critically how most food producers lack: good technology, adequate Finance, larger access to the buyers of farm produce. Farmspired was initialized to solve the aforementioned problems and more.",
            color: '#DDA639',
            theme: 'Zero-Hunger',
            about: "Farmspired introduces a platform where food producers can display their harvests and potential retailers can buy these products. A potential retailer can see the summary of the average price a product is sold(as it compares to a farmer's produce)Farmers can be rated by their produce, sales and customer relationsInvestors can see a list of top farmers and choose to invest in whoever they choose.",
            featured: false,
            videoLink: '',
            stackused: ["React Js"],
            nationality: ["Nigeria"],
            email: "aimakhededavido@gmail.com",
            hostedlink: 'http://farmspired.netlify.app',
            members: [
                "AbdulAzeez Atanda",
                "Abdulazeez Dolapo Abdulrafiu",
                "Abizeyimana Victor",
                "Adetimehin James",
                "Aimakhede David OseOjie",
                "Akanimo Akpan",
                "GODSWILL EFFIONG",
                "Michael Goboola",
                "Patrick Okero",
            ...
            image: 'https://res.cloudinary.com/dt69gb9me/image/upload/f_auto,q_auto/v1596270365/farmspired_x6g8ir.png',
