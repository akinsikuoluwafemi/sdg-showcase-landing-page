                    ...
                    <div className="container py-5">
                        <div className="row">
                            <div className="col-lg-8 col-sm-12">
                                ...
                                <p style={{ color: '#10689D' }} className="h4 pb-2">- With the growing increase and ease of technology device the power of the media most directly social media is unstoppable. This advancement is creating rapidly a world where information and communication can no longer be controlled. False reports and hate speeches have overtime been the rising cause of insurgencies and insecurities in our communities. </p>
                            </div>
