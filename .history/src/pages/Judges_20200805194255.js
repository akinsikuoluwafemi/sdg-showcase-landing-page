        ...
        <div className={darkMode ? `dark-mode bg-section2` : `light-mode bg-section2`}>
            ...
            <div className="container">
                ...
                <div className="row my-3">
                    ...
                    <div className="col-lg-8 col-sm-12">
                        <h2 className={darkMode ? `color-light h1 font-weight-bold mb-3` : ` h1 color-dark font-weight-bold`}>How we scored and judges</h2>
                        ...
                        <div className="h2">
                            <ol>
                                <li>Quality of the Idea: The creativity, authenticity, and originality of the idea was tested and this criterion had a score of 30%</li>
