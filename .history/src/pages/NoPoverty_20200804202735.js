                    ...
                    <div className="container py-5">
                        <div className="row">
                            <div className="col-lg-8 col-sm-12">
                                <h2 className="font-weight-bold ">Problem Statements</h2>
                                <p className="h3">- IMPLEMENT POLICIES BY MOBILIZING RESOURCES TOWARDS ENDING  POVERTY.</p>
                                <p style={{color: '777'}} className="h4">If we can implement policies to ensure resources are organized and create programs that will end poverty in all its dimensions, we can bring Poverty across developing and under-developing countries to a halt. </p>
                                <p className="h4">If we can implement policies to ensure resources are organized and create programs that will end poverty in all its dimensions, we can bring Poverty across developing and under-developing countries to a halt. </p>
