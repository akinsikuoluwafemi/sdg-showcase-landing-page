            ...
            <div className="container">
                ...
                <div className="row">
                    ...
                    <div className="col-lg-6 col-sm-12">
                        ...
                        <p className="h3 mt-5">The pitch-a-thon involved selecting a team of expert judges that make up some of the brightest minds in our ecosystem. Each team project was judged based on three criteria communicated to them at the start of the cohort;</p>
