        ...
        <ModalContext.Provider value={{ showModal, setShowModal }}>
            ...
            <div>
                ...
                <div className="bg-header">
                    ...
                    <div>
                        <span className="h2 font-weight-bold">2500+ Developers from 5 SubSaharan Africa Countries created 150+ projects using 450k+ lines of Code in 6 weeks to #BuildforSDG</span>
                    </div>
                ...
                <div className={darkMode ? `dark-mode` : `light-mode`}>
                    <div className="container ">
                        <div className="row twobuttons">
                            <div >
                                <Link className="projects-btn pr-2" to="/projects">See all projects →</Link>
                                <Link className="projects-btn" to="/projects">Meet the Judges→</Link>
