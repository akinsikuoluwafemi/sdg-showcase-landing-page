                ...
                <div className="row my-5">
                    <div className="col">
                        ...
                        <div className="themeproject-container">
                            ...
                            <Link to="/themes/Quality-Education" style={{ background: '#C5192D', boxShadow: '#fff 0px 0px 0px 3px, #10689D 0px 0px 0px 6px' }} className='text-white health font-weight-bold px-2 py-3'>Quality-Education</Link>
