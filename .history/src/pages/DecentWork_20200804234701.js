        ...
        <DecentModalContext.Provider value={{ decentModal, setDecentModal}}>
            <div className={darkMode ? `dark-mode bg-section2` : `light-mode bg-section2`}>
                ...
                <div className="container">
                    <div style={{ color: '#A21942' }} className="theme-project"><span className={darkMode ? 'color-dark' : 'color-light'}>Theme</span></div>
                    ...
                    <div className="container py-5">
                        <div className="row">
                            <div className="col-lg-8 col-sm-12">
                                ...
                                <p style={{ color: '#A21942' }} className="h4 pb-2">- We need technology to counter these technology crimes, think of a technology solution that could check, signal, monitor and solve the growing increase of global security concerns (i.e cybercrime, economic espionage). </p>
