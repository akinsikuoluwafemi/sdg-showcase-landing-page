            ...
            <div className="container">
                ...
                <div className="row my-3">
                    ...
                    <div className="col-lg-8 col-sm-12">
                        ...
                        <p className={darkMode ? `color-light text-space h3 font-weight-bold mb-3` : `color-dark text-space h3 font-weight-bold`}>The team’s projects were judged based on these three criteria.</p>
