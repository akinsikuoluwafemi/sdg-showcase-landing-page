            ...
            <div className="container">
                ...
                <div className="row my-3">
                    ...
                    <div className="col-lg-8 col-sm-12">
                        ...
                        <p className={darkMode ? `color-light text-space h3 font-weight-bold` : `color-dark text-space h3 font-weight-bold`}>The team’s projects were judged based on these three criteria.</p>

                        <div className="h2">
                            <ol>
                                <li><span className="font-weight-bold">Quality of the Idea</span>: The creativity, authenticity, and originality of the idea was tested and this criterion had a score of 30%</li>
