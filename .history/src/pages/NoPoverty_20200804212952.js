        ...
        <NoPovertyModalContext.Provider value={{ noPovertyModal, setNoPovertyModal}}>
            <div className={darkMode ? `dark-mode bg-section2` : `light-mode bg-section2`}>
                ...
                <div className="container">
                    <div style={{ background: '#E5243B'}} className="theme-project"><span className={darkMode ? 'color-dark' : 'color-light'}>Theme</span></div>

                    <h2 style={{ background: '#E5243B' }} className="top-projects  my-5">No Poverty</h2>
