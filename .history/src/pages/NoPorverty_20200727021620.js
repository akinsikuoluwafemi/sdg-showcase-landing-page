...
export default function NoPorverty() {
    ...
    box-shadow: #fff 0px 0px 0px 3px, #E5243B 0px 0px 0px 6px;
                                                    
                            <Link to="/themes/No-Poverty" style={{ background: '#E5243B', boxShadow:  }} className='povactive text-white health font-weight-bold px-2 py-3'>
                                No Poverty
                                </Link>
