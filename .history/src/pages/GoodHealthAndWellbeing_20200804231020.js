                    ...
                    <div className="container py-5">
                        <div className="row">
                            <div className="col-lg-8 col-sm-12">
                                ...
                                <p style={{ color: '#6FB364' }} className="h4 pb-2">- Develop a solution platform that could increase the availability of high-quality, timely and reliable data relevant to aid national statistical planning. </p>
                                ...
                                <p style={{ color: '#6FB364' }} className="h4 pb-2">- Develop a tech solution that could help improve revenue collection within your local government/community. </p>
                            </div>
