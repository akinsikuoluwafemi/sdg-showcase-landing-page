                    ...
                    <div className="container py-5">
                        <div className="row">
                            <div className="col-lg-8 col-sm-12">
                                ...
                                <p style={{ color: '#A21942' }} className="h4 pb-2">- Help build a tech solution that could help achieve universal access to Banking or a solution that can redeem insurance benefits worldwide. </p>
                            </div>
