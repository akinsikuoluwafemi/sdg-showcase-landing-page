        ...
        <div className={darkMode ? `dark-mode bg-section2` : `light-mode bg-section2`}>
            ...
            <div className="container">
                ...
                <div className="row my-3">
                    ...
                    <div className="col-lg-8 col-sm-12">
                        <h2 className={darkMode ? `color-light h1 font-weight-bold` : ` h1 color-dark font-weight-bold`}>How we scored and judges</h2>
                        <p className={darkMode ? `color-light text-space h3 font-weight-bold` : `color-dark text-space h3 font-weight-bold`}>The team’s projects were judges based on three criteria.</p>

                        <p className="h3 my-4">The pitch-a-thon involved selecting a team of expert judged that make up some of the brightest minds in our ecosystem. Each team project was judged based on three criteria communicated to them at the start of the cohort;</p>
