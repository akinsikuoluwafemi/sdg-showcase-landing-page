                ...
                <div className="row my-5">
                    <div className="col">
                        ...
                        <div className="themeproject-container">
                            ...
                            <Link to="/themes/Peace-And-Justice" style={{ background: '#10689D', boxShadow: '#fff 0px 0px 0px 3px, #A21942 0px 0px 0px 6px' }} className='text-white health font-weight-bold px-2 py-3'>Peace-And-Justice</Link>
