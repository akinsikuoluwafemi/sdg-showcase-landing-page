                    ...
                    <div className="container py-5">
                        <div className="row">
                            <div className="col-lg-8 col-sm-12">
                                ...
                                <p style={{ color: '#F90F65'}} className="h4">Build a tech solution that could be implemented to help reduce poverty in your community. (First of think about the major causes of poverty in your community) </p>
