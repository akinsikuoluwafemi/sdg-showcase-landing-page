        ...
        <HealthModalContext.Provider value={{ healthModal, setHealthModal }}>
            <div className={darkMode ? `dark-mode bg-section2` : `light-mode bg-section2`}>
                ...
                <div className="container">
                    ...
                    <h2 className="top-projects  my-5">Good Health And Wellbeing</h2>
                    ...
                    <div className="row my-5">
                        <div className="col">
                            <p className={darkMode ? `color-light font-weight-bold h2 text-theme mb-5` : `color-dark  h2 text-theme mb-5`}>Explore by theme</p>
                            ...
                            <div className="themeproject-container">
                                ...
                                <Link to="/themes/Good-Health-And-Wellbeing" style={{ background: '#4C9F38', boxShadow: '#fff 0px 0px 0px 3px, #4C9F38 0px 0px 0px 6px' }} className='text-white health font-weight-bold px-2 py-3'>Good Health and...</Link>
