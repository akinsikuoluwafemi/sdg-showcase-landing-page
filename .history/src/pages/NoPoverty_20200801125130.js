                    ...
                    <div className="row my-5">
                        <div className="col">
                            ...
                            <div className="themeproject-container">
                                ...
                                <Link to="/themes/No-Poverty" style={{ background: '#E5243B', boxShadow: { darkMode? `#fff 0px 0px 0px 3px, #E5243B 0px 0px 0px 6px` : '#fff 0px 0px 0px 3px, #E5243B 0px 0px 0px 6px'} }} className='povactive text-white health font-weight-bold px-2 py-3'>
                                    No Poverty
                                </Link>
