                    ...
                    <div className="container py-5">
                        <div className="row">
                            <div className="col">
                                ...
                                <p>If we can implement policies to ensure resources are organized and create programs that will end poverty in all its dimensions, we can bring Poverty across developing and under-developing countries to a halt. 
</p>
                            </div>
