                ...
                <div className="row my-5">
                    <div className="col">
                        ...
                        <div className="themeproject-container">
                            ...
                            <Link to="/themes/Industry-innovation" style={{ background: '#FA6926', boxShadow: '#fff 0px 0px 0px 3px, #FB9D24 0px 0px 0px 6px' }} className='text-white health font-weight-bold px-2 py-3'>Industry-Innovation</Link>
