                    ...
                    <div className="container py-5">
                        <div className="row">
                            <div className="col-lg-8 col-sm-12">
                                ...
                                <p style={{ color: '#DDA639' }} className="h4 pb-2">- Build a tech solution that could be implemented to help reduce poverty in your community. (First of think about the major causes of poverty in your community) </p>
                                ...
                                <p style={{ color: '#DDA639' }} className="h4 pb-2">- We encourage your team to build a solution that could allow communities to access equal rights to economic resources(financial) or other basic resources. </p>
                            </div>
