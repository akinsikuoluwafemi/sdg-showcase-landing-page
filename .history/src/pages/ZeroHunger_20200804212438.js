                    ...
                    <div className="container py-5">
                        <div className="row">
                            <div className="col-lg-8 col-sm-12">
                                ...
                                <p style={{ color: '#DDA639' }} className="h4 pb-2">- Build tech solutions that could help give your local community access to international/advanced farming practices that could assist them to improve their infrastructure or farming practices.
 </p>
                            </div>
