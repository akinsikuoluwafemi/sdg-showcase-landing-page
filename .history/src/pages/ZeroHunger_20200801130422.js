                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-sm-12">
                            <p className={darkMode ? `color-light text-space h3 font-weight-bold` : `color-dark text-space h3 font-weight-bold`}>The number of undernourished people has dropped by almost half in the past two decades because of rapid economic growth and increased agricultural productivity. Many developing countries that used to suffer from famine and hunger can now meet their nutritional needs. Central</p>
                        </div>
                    </div>
                    ...
                    <div className="row my-5">
                        <div className="col">
                            ...
                            <div className="themeproject-container">
                                ...
                                <Link to="/themes/Zero-Hunger" style={{ background: '#DDA639', boxShadow: darkMode ? `#fff 0px 0px 0px 3px, #E5243B 0px 0px 0px 6px` : `#222 0px 0px 0px 3px, #E5243B 0px 0px 0px 6px` }} }} className='text-white active-box health font-weight-bold px-2 py-3'>Zero Hunger</Link>
