                    ...
                    <div className="row my-5">
                        <div className="col">
                            ...
                            <div className="themeproject-container">
                                ...
                                <Link to="/themes/Patnerships-For-Goals" style={{ background: '#19486A', darkMode? `#222 0px 0px 0px 3px, #E5243B 0px 0px 0px 6px` : `#fff 0px 0px 0px 3px, #E5243B 0px 0px 0px 6px` }} className='text-white health font-weight-bold  px-2 py-3'>Partnership 4Goals</Link>
