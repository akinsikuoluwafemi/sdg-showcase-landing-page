        ...
        <div className={darkMode ? `dark-mode bg-section2` : `light-mode bg-section2`}>
            ...
            <div className="container">
                ...
                <div className="row my-3">
                    <div className="col-lg-8 col-sm-12">
                        <h2 className={darkMode ? `color-light h1 font-weight-bold mb-4` : ` h1 color-dark font-weight-bold  mb-4`}>Number of teams that participated</h2>
                        <p className="h3 mb-3">60 teams</p>
                    </div>
                ...
                <div className="row">
                    ...
                    <div className="col-lg-8 col-sm-12">
                        <h2 className={darkMode ? `color-light h1 font-weight-bold mb-4` : ` h1 color-dark font-weight-bold  mb-4`}>How we scored and judges</h2>
