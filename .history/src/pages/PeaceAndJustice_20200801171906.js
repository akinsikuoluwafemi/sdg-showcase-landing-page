                    ...
                    <div className="row my-5">
                        <div className="col">
                            ...
                            <div className="themeproject-container">
                                ...
                                <Link to="/themes/Peace-And-Justice" style={{ background: '#10689D', boxShadow: darkMode ? `#222 0px 0px 0px 3px, #10689D 0px 0px 0px 6px` : `#fff 0px 0px 0px 3px, #C5192D 0px 0px 0px 6px` }} className='text-white health font-weight-bold px-2 py-3'>Peace-And-Justice</Link>
