...
const Projects = () =>{
    ...
    return (
        <AllProjectModalContext.Provider value={{ allProjectModal, setAllProjectModal }}>
            <div className={darkMode ? `dark-mode bg-section2` : `light-mode bg-section2`}>

                <Header />
                <div className="container">

                    <h2 style={{ color: '#0459DF'}} className="top-projects  my-5">Top 60 projects page</h2>
        ...
        </AllProjectModalContext.Provider>
