            ...
            <div className="container">
                ...
                <div className="row my-3">
                    ...
                    <div className="col-lg-8 col-sm-12">
                        ...
                        <div className="h2">
                            <ol>
                                <li><span className="font">Quality of the Idea</span>: The creativity, authenticity, and originality of the idea was tested and this criterion had a score of 30%</li>
