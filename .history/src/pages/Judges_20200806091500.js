    ...
    return (
        <div className={darkMode ? `dark-mode bg-section2` : `light-mode bg-section2`}>
            ...
            <div className="container">
                ...
                <div className="">
                    <p className={darkMode ? `color-light font-weight-bold text-space h3 text-center  mb-3` : `mb-3 font-weight-bold text-center color-dark text-space h3 `}>Also, a video containing the top 15 teams can be viewed below </p>
