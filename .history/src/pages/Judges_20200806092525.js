    ...
    return (
        <div className={darkMode ? `dark-mode bg-section2` : `light-mode bg-section2`}>
            ...
            <div className="container">
                ...
                <div className="row ">
                    <div className="col-12 col-lg-6 m-auto mx-4 my-4">
                        <p className={darkMode ? `color-light font-weight-bold text-space h3  ` : `font-weight-bold text-center color-dark text-space h3 `}>Also, a video containing the top 15 teams can be viewed below </p>
