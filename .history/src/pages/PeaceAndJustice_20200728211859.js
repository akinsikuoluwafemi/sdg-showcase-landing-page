import React, {useSt useContext, useEffect} from 'react';
    ...
    return (
        <>
            ...
            <div className="container">
                ...
                <h2 className="top-projects  my-5">Peace And Justice</h2>
                ...
                <div className="row my-5">
                    <div className="col">
                        ...
                        <div className="themeproject-container">
                            ...
                            <Link to="/themes/Peace-And-Justice" style={{ background: '#10689D', boxShadow: '#fff 0px 0px 0px 3px, #10689D 0px 0px 0px 6px' }} className='text-white health font-weight-bold px-2 py-3'>Peace-And-Justice</Link>
                ...
                <div className="container">
                    <PeaceList projects={peaceAndJustice}/>
                </div>
