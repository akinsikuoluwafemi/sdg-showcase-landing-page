        ...
        <PatnershipModalContext.Provider value={{ patnerModal, setPatnerModal}}>
            <div className={darkMode ? `dark-mode bg-section2` : `light-mode bg-section2`}>
                ...
                <div className="container">
                    ...
                    <h2 className="top-projects  my-5">Partnership for Goals</h2>

                    <div className="row">
                        <div className="col-lg-6 col-sm-12">
                            <p className={darkMode ? `color-light text-space h3 font-weight-bold` : `color-dark text-space h3 font-weight-bold`}>The SDGs can only be realized with strong global partnerships and cooperation. Official Development Assistance remained steady but below target, at US$147 billion in 2017. While humanitarian crises brought on by conflict or natural disasters continue to demand more financial resources and aid.</p>
                        </div>
                    </div>
                    ...
                    <div className="row my-5">
                        <div className="col">
                            ...
                            <div className="themeproject-container">
                                ...
                                <Link to="/themes/Patnerships-For-Goals" style={{ background: '#19486A', boxShadow: darkMode ? `#222 0px 0px 0px 3px, #19486A 0px 0px 0px 6px` : `#fff 0px 0px 0px 3px, #E5243B 0px 0px 0px 6px` }} className='text-white health font-weight-bold  px-2 py-3'>Partnership 4Goals</Link>
