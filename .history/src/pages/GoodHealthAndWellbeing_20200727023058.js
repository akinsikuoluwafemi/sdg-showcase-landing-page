                ...
                <div className="row my-5">
                    <div className="col">
                        ...
                        <div className="themeproject-container">
                            ...
                            <Link to="/themes/Patnerships-For-Goals" style={{ background: '#19486A', boxShadow: '#fff 0px 0px 0px 3px, #4C9F38 0px 0px 0px 6px' }} className='text-white health font-weight-bold  px-2 py-3'>Patnership 4Goals</Link>
