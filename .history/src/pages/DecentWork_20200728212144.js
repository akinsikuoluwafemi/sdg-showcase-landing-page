...
import { DecentModalContext} from '../contexts/'
import Aos from 'aos';
    ...
    return (
        <>
            ...
            <div className="container">
                ...
                <div className="row my-5">
                    <div className="col">
                        ...
                        <div className="themeproject-container">
                            ...
                            <Link to="/themes/Decent-Work" style={{ background: '#A21942', boxShadow: '#fff 0px 0px 0px 3px, #A21942 0px 0px 0px 6px' }} className='text-white health font-weight-bold px-2 py-3'>Decent-Work</Link>
                ...
                <div className="container">
                    <DecentList projects={decentWork}/>
                </div>
