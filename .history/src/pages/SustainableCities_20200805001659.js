        ...
        <SustainableModalContext.Provider value={{ sustainModal, setSustainModal}}>
            <div className={darkMode ? `dark-mode bg-section2` : `light-mode bg-section2`}>
                ...
                <div className="container">
                    <div style={{bac}} className="theme-project"><span className={darkMode ? 'color-dark' : 'color-light'}>Theme</span></div>
                    ...
                    <div className="container py-5">
                        <div className="row">
                            <div className="col-lg-8 col-sm-12">
                                ...
                                <p style={{ color: '#FB9D24' }} className="h4 pb-2">- Critically examine your community and the feasibility of a working alternate transport solution, with special attention to the needs of those in vulnerable situations, women, children, persons with disabilities and older persons. Build it and wow us .</p>
