                    ...
                    <div className="container py-5">
                        <div className="row">
                            <div className="col-lg-8 col-sm-12">
                                ...
                                <p style={{ color: '#FB9D24' }} className="h4 pb-2">- Come up with a tech solution that is innovative and could create accessible and inclusive financial systems for your community. Your solutions delivery model must be adaptable and scalable for a growing community. </p>
                            </div>
