                    ...
                    <div className="container ">
                        <div className="row">
                            <div className="col-12 col-lg-9 my-5 intro-container">
                                ...
                                <p className={darkMode ? `color-light text-theme` : `color-dark`}>The <span style={{ color: '#0fddff' }}>Goal of the #BuildforSDG Challenge 2020</span> is to empower developers to build global, high-value, high-impact projects to help improve their market-readiness while learning within the community.</p>
                            </div>
                        </div>
