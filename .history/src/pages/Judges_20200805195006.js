            ...
            <div className="container">
                ...
                <div className="row my-3">
                    ...
                    <div className="col-lg-8 col-sm-12">
                        ...
                        <p className={darkMode ? `color-light text-space h3  mb-3` : `mb-3 color-dark text-space h3 font-weight-bold`}>With the total score equating to 100%, the teams had to pitch their projects to a panel of expert judges.</p>
