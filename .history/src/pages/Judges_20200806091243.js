    ...
    return (
        <div className={darkMode ? `dark-mode bg-section2` : `light-mode bg-section2`}>
            ...
            <div className="container">
                ...
                <div className="row py-3">
                    <p className={darkMode ? `color-light text-space h3 text-center  mb-3` : `mb-3 text-center color-dark text-space h3 `}>The 15 teams that qualified for the next phase are </p>
