        ...
        <ModalContext.Provider value={{ showModal, setShowModal }}>
            ...
            <div>
                ...
                <div className="bg-header">
                    ...
                    <div>
                        <span className="build-challenge">2500+ Developers from 5 SubSaharan Africa Countries created 150+ projects using 450k+ lines of Code in 6 weeks to #BuildforSDG</span>
                    </div>
