export default [
    ...
    },
    {
        ...
        fields: {
            name: 'Mentel',
            headline: "Our app will allow people to get professional help, without the fear of stigma, and under confidentiality. Our data could also possibly help researchers to get an overview of the mental challenges we are tackling, without, of course, disclosing the details of our clients.",
            color: '#4C9F38',
            theme: 'Good-Health-and-Well-being',
            headline: "The Inspiration behind my team's project is a personal one. I, the team lead have lived and is living with people that have suffered some form of mental challenge at different points in time, and as we discussed, it turns out my team members can relate as well - so among the projects we suggested, we all agreed to go with tackling this problem.",
            featured: false,
            videoLink: "",
            stackused: ["React Js"],
            nationality: ["Nigeria"],
