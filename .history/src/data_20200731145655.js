export default [
    ...
    },
    {
        ...
        fields: {
            ...
            color: '#4C9F38',
            theme: 'Good-Health-and-Well-being',
            headline: "Our inspiration is from the stigma mentally ill people face and how to reduce the stigma and make mental health services more accessible to all people at the community level as well without discrimination or stigmatization.",
            featured: false,
    ...
    },
    {
        ...
        fields: {
            name: 'Helow project',
            about: "Our app would enable anyone with a smart phone and internet access to report any accident scene they encounter to the right bodies and agencies responsible for it to save as many lives as possible.",
            color: '#4C9F38',
            theme: 'Good-Health-and-Well-being',
            headline: "Helow stands for HElp is On the Way. My team was motivated by the passion to save lives on the highways from road accidents bearing in mind that  accidents are quite unavoidable. However, it should not be a death sentence. We want to mitigate the mortality rates by developing a smart report/response system on the go.",
            featured: false,
            videoLink: "",
            stackused: ["React Js"],
            nationality: ["Nigeria"],
