...
import agro from '../images/agromart.png';

const style = { backgroundImage: url('https://images.unsplash.com/photo-1593642531955-b62e17bdaa9c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80'), backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }

export default function AllProjectsDetails({ allProject }){


    let { allProjectModal, setAllProjectModal } = useContext(AllProjectModalContext);
    console.log(allProjectModal + 'from allprojectdetail');
        ...
        <div className={allProjectModal ? `modal` : `hide-modal`}>
            ...
            <div style={{ background: `${allProject.color}` }} className="shadow-lg  modal-content">
                ...
                <div className="inner-content">
                    ...
                    {allProject.videoLink.length === 0 ? <div style={styles}></div> :
