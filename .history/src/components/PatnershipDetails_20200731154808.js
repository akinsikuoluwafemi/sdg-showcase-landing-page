...
export default function PatnershipDetails({project}) {
    ...
    return (
        <div className={patnerModal ? `modal` : `hide-modal`}>
            ...
            <div style={{ background: `${project.color}` }} className="shadow-lg  modal-content">
                ...
                <div className="inner-content">
                    ...
                    {project.videoLink.length === 0 ? <div className=" small-img big-image img-responsive" style={{ backgroundImage: `url(${project.image})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'cente' }}></div> :

                        <div className='player-wrapper'>

                            <ReactPlayer
                                playing={patnerModal ? true : false}
