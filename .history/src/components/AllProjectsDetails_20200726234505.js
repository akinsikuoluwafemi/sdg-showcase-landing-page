        ...
        <div className={allProjectModal ? `modal` : `hide-modal`}>
            ...
            <div style={{ background: `${allProject.color}` }} className="shadow-lg  modal-content">
                ...
                <div className="inner-content">
                    ...
                    {allProject.videoLink.length === 0 ? <div style={{ backgroundImage: `url(${allProject.image})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center'}}></div> :
