   ...
   render(){
       ...
       return (
           <section className="themes-container">
               ...
               </Link>  <Link to="/themes/no-poverty" style={{ background: '#19486A' }} className=" card health ">
                   <div className=" text-white font-weight-bold font-italic">Patnerships-For-Goals</div>
               </Link>
               <Link to="/themes/Patnerships-For-Goals" style={{ background: '#4C9F38' }} className=" card health ">
                   <div className=" text-white font-weight-bold font-italic">Good-Health-And-Wellbeing</div>
               </Link>
               <Link to="/themes/Good-Health-And-Wellbeing" style={{ background: '#C5192D' }} className=" card health ">
                   <div className=" text-white font-weight-bold font-italic">Quality-Education</div>
               </Link>
               <Link to="/themes/Quality-Education" style={{ background: '#10689D' }} className=" card health ">
