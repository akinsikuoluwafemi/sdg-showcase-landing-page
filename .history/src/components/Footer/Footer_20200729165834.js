            ...
            <footer className="footer foote">
                ...
                <div className={darkMode ? ` footer-background dark-footer` : ` footer-background light-footer`}>
                    <div className="footer-text">
                        <p>This website was built by  <a style={{ color: '#35DDFF' }} href="https://femiakin.com/">Femi</a>, a Programme Assistant in the <span style={{ color: '#0fddff' }}>#BUILDFORSDG.</span></p>
