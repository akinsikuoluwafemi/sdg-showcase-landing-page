                ...
                <div className="inner-content ">
                    ...
                    <div className="vidd">
                        <div class="iframe-container">
                            <iframe onPause={handlePaused} ref={videoRef} title="youtube-video" width="560" height="315" src={project.videoLink} frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                    </div>
