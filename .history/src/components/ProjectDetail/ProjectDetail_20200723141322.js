            ...
            <div style={{background: `${project.color}`}} className="shadow-lg  modal-content">
                <div className="header-modal">
                    ...
                    <div className="icon-modal">
                        <a href="" onClick={() => setShowModal(false)} className="close">
                ...
                <div className="inner-content ">
                    ...
                    <div className="vidd">
                        <div class="iframe-container">
                            <iframe title="youtube" width="560" height="315" src={project.videoLink} frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                    </div>
