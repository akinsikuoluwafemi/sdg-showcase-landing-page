            ...
            <div className="shadow-lg  modal-content">
                ...
                <div className="text-project">
                    <div className="pt-5">
                        ...
                        <p className="h3 info">This project is modeled to be far more effective in terms of environmental impact as there would be plastic waste reduction and improved recycling.</p>
                    </div>

                    <div>
                        <h2 className="font-weight-bold">Facebook Open source used</h2>
                        <p className="h3 info">React</p>
                    </div>
                    <div>
