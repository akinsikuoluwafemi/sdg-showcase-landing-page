...
export default function ProjectDetail({ project }){
    ...
    const closeModal = () => {
        setShowModal(false)
        // if(videoRef.current.onpause === null){
            // videoRef.current.pause()
        // }
        videoRef.getInternalPlayer()..getInternalPlayer().pauseVideo()

        
    }

    const handlePaused = () => {
        console.log('you just paused');
    }
                ...
                <div className="inner-content ">
                    ...
                    <div className="vidd">
                        <div class="iframe-container">
                            <iframe onPause={() => console.log('paused')} ref={videoRef} title="youtube-video" width="560" height="315" src={project.videoLink} frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                    </div>
