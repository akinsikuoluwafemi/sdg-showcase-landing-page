            ...
            <div className="shadow-lg  modal-content">
                ...
                <div>
                    <div className="pt-5">
                        ...
                        <p className="">This project is modeled to be far more effective in terms of environmental impact as there would be plastic waste reduction and improved recycling.</p>
                    </div>

                    <div>
                        <h2 className="">Facebook Open source used</h2>
                        <p>React</p>
                    </div>
                    <div>
