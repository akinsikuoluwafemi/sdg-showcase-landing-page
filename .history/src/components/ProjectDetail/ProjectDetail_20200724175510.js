            ...
            <div style={{ background: `${project.color}` }} className="shadow-lg  modal-content">
                <div className="header-modal">
                    ...
                    <div className="icon-modal">
                        <span style={{ color: 'white' }} onClick={close} className="close">
                ...
                <div className="inner-content ">
                    ...
                    <div className="vidd">
                        <div class="iframe-container">
                            <iframe ref={videoRef} title="youtube-video" width="560" height="315" src={project.videoLink} frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                    </div>
