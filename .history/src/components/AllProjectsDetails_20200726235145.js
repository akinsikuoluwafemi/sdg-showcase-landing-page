        ...
        <div className={allProjectModal ? `modal` : `hide-modal`}>
            ...
            <div style={{ background: `${allProject.color}` }} className="shadow-lg  modal-content">
                ...
                <div className="inner-content">
                    ...
                    {allProject.videoLink.length === 0 ? <div className="img-responsive" style={{ backgroundImage: `url(${allProject.image})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center', height: '40rem'}}></div> :
