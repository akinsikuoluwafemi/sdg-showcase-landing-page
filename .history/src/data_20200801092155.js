export default [
    ...
    },
    {
        ...
        fields: {
            ...
            color: '#DDA639',
            theme: 'Zero-Hunger',
            about: "Farmspired introduces a platform where food producers can display their harvests and potential retailers can buy these products. A potential retailer can see the summary of the average price a product is sold(as it compares to a farmer's produce)Farmers can be rated by their produce, sales and customer relations
Investors can see a list of top farmers and choose to invest in whoever they choose.",
            featured: false,
            videoLink: 'https://www.youtube.com/embed/mbyTks3_GGs',
            stackused: [],
            nationality: ["Nigeria"],
