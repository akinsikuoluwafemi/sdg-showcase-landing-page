export default [
    ...
    },
    {
        ...
        fields: {
            name: 'Safe Haven',
            headline: "This project enables anyone to have a quick discussion with a professional who will not judge them based on their mental state. If need be, users can also create reoccurring sessions with specialists.",
            color: '#4C9F38',
            theme: 'Good Health and Well-being',
