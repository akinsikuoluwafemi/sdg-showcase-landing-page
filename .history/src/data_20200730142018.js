export default [
    ...
    },
    {
        ...
        fields: {
            name: 'MentalHealth4U',
            headline: "My team's project is driven by the need to manage mental-health issues that might arise as a result of the current lock-down around the world. We intend to make access to professionals in this field a seemless process.",
            color: '#4C9F38',
            theme: 'Good-Health-and-Well-being',
            about: "The app will help mental-health patients obtain recommendation on location of mental-health speciasts around them. The entire process from booking an appointment to consultation.",
            featured: false,
            videoLink: "",
            stackused: [],
            nationality: ["Nigeria"],
