    ...
    <>
       <ModeContext.Provider value={{ darkMode, setDarkMode }}>
         ...
         <button style={{ outline: 'none' }} >
           ...
           <label class="label">
             <div class="toggle">
               <input onClick={() => setDarkMode(prevMode => !prevMode)} className={darkMode ? `mode-change toggle-state grey ` : `mode-change toggle-state slate `} type="checkbox" name="check" value="check" />
